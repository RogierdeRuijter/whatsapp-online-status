<!-- TODO: rename component to clear component or move it into the canvas component -->
<script lang="ts">
  import {
...
<div>
  <!-- <div class="d-flex flex-row justify-content-center align-items-center my-4">
    <div class="mx-3">
      <input
        ...
        value=""
        id="addSquare"
        checked={addSquareChecked}
        on:click={handleAddSquareChecked} />
      <label class="form-check-label" for="addSquare"> Add square </label>
    </div>
    <div class="mx-3">
      <input
        class="form-check-input"
        ...
        value=""
        id="addCircle"
        checked={addCircleChecked}
        on:click={handleAddCircleChecked} />
      <label class="form-check-label" for="addCircle"> Add circle </label>
    </div>
    <div class="mx-3">
      <input
        class="form-check-input"
        ...
        value=""
        id="addFlag"
        checked={addFlagChecked}
        on:click={handleAddFlagChecked} />
      <label class="form-check-label" for="addFlag"> Add flag </label>
    </div>
  </div> -->
  ...
  <div class="d-flex justify-content-center my-4">
    <button
      ...
      on:click={handleClearButtonClick}>Clear</button>
  </div>
